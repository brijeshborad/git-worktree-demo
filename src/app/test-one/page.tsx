...
export default function TestOne() {
    ...
    return (
        <div className={`min-h-screen transition-colors duration-300 ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'} py-4 sm:py-12 px-4`}>
            <div className="max-w-4xl mx-auto">
                ...
                <div className={`${darkMode ? 'bg-gray-800' : 'bg-white'} rounded-xl shadow-lg p-4 sm:p-8 transition-colors duration-300`}>
                    <div className="flex flex-col sm:flex-row items-center sm:space-x-6 space-y-4 sm:space-y-0 mb-8">
                        <div className="w-24 h-24 sm:w-32 sm:h-32 bg-gradient-to-br from-blue-500 to-purple-600 rounded-full flex items-center justify-center text-3xl sm:text-5xl font-bold text-white shadow-lg">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
                        <div className={`text-center p-4 sm:p-6 rounded-lg transition-all duration-200 hover:scale-105 ${
                        ...
                        <div className={`text-center p-4 sm:p-6 rounded-lg transition-all duration-200 hover:scale-105 ${
                            ...
                            <p className="text-xl sm:text-2xl font-bold">8.5k</p>
                            <p className={`text-sm sm:text-base ${
                                darkMode ? 'text-gray-300' : 'text-gray-600'
                            }`}>Likes</p>
                        </div>
